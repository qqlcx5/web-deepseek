...
- [ ] thinking / error / citation / tool block 用对应组件渲染。
  - 输入：`message.blocks`。
...
- [ ] 消息渲染使用 Bubble/BubbleList/XMarkdown，无 `<article>` 手写结构。
- [ ] 滚动追底、未读角标、回底按钮正常。
- [ ] 思考、错误、引用、工具、usage 全部可渲染。
